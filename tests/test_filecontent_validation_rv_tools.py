...
from . import get_mock_binary_files, headers, tenant_id

# python3 -m unittest tests/test_filecontent_validation_rv_tools.py


uploader_id = "rv_tools"


class Testrv_toolsContent(unittest.TestCase):
    def setUp(self):
    ...
    def test_filecontent_validation(self):
        ...
        time.sleep(3)
        uploader_response, _ = get_uploader_status(
            tenant_id, uploader_id=uploader.uploader_id
        )
    ...
    def test_mongo_data_saved(self):
        ...
        quota_saved = mongodata.fetch(
            match={"tenant_id": tenant_id, "uploader_id": uploader_id},
