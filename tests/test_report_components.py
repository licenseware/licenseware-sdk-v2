...
from licenseware.common.constants import filters, icons
...
fe_filters = [
    {"column": "name", "filter_type": "equals", "filter_value": "the device name"}
]
...
class TestReportComponents(unittest.TestCase):
    def test_report_component_creation(self):
        class VirtualOverview(BaseReportComponent):
            def __init__(self, title: str, component_id: str, component_type: str):
                self.title = title
            ...
            def get_data(self, flask_request):
                ...
                self.get_mongo_match_filters(flask_request)
            ...
            def set_style_attributes(self):
                ...
                self.style_attributes = {"width": "1/3"}
        ...
        virtual_overview = VirtualOverview(
            title="Overview", component_id="virtual_overview", component_type="summary"
        )
        ...
        self.assertEqual(
            registration_payload["attributes"]["series"],
            [
                {
                    "value_description": "Number of devices",
                    "value_key": "number_of_devices",
