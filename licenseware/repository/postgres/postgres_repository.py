...
class PostgresRepository(RepositoryInterface):
    ...
    def update(self, schema_name:str, filters:dict, data:Union[dict, List[dict]], first: bool = False) -> CursorResult:
        """ """
    ...
    def update_many(self, schema_name:str, filters:dict, data:List[dict], validate_percentage:float = 1.0) -> CursorResult:
        """
            Update many
